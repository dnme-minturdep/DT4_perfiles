...
```{r identificacióndelosvisitantes, echo=FALSE, fig.cap="Fifura1" }
...
```{r Margenesdeerrorseguntamaño, echo=FALSE, fig.cap="Grafico 2" }
...
```{r Tamañodelamuestra, echo=FALSE, fig.cap="Gradico 3" }
...
```{r Intervalodeconfianza, echo=FALSE, fig.cap="Grafico4" }
...
```{r Tamañodemuestra, echo=FALSE, fig.cap="Grafico5" }
...
```{r Lugarderesidencia, echo=FALSE, fig.cap="Figura2" }
...
```{r Coeficientes, echo=FALSE, fig.cap="Tabla1" }
...
```{r Casosencuestados, echo=FALSE, fig.cap="Tabla2" }
...
```{r Clasificaciondepersonas, echo=FALSE, fig.cap="Tabla3" }
...
```{r Motivo, echo=FALSE, fig.cap="Tablaa4" }
...
```{r Muestraposible, echo=FALSE, fig.cap="Tabla4" }
...
```{r Gastototal, echo=FALSE, fig.cap="figura3" }
...
```{r Tipodetraslado, echo=FALSE, fig.cap="Tabla5" }
...
```{r Casos, echo=FALSE, fig.cap="Tabla6" }
...
```{r Totalreal, echo=FALSE, fig.cap="Tabla7" }
...
```{r Formadecalculo, echo=FALSE, fig.cap="Tabla8" }
