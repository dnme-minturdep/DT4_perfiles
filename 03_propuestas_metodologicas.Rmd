...
[^propuestas_metodologicas-4]: En las encuestas de viajes y turismo de los hogares, el visitante constituye una de las posibles unidades de análisis. Por ejemplo, allí es posible caracterizar a la población de acuerdo a su comportamiento turístico (por caso, si han realizado o no viajes turísticos dentro de un determinado periodo temporal de referencia) y por tanto, las unidades de análisis pasarían a ser las personas. Bajo, la misma lógica, los hogares también pueden ocupar el lugar de unidades de análisis.
    ...
    Tanto en las encuestas a hogares como en las encuestas realizadas en destino, los grupos de viajes también pueden ser tomados como unidad de análisis.
...
```{r identificacióndelosvisitantes, echo=FALSE, fig.cap="Esquema de identificación de visitantes" , out.width='100%' }
...
* $z =$ valor estandarizado para el nivel de confianza deseado. **Para una confianza del 90%,** $z$ **es igual a** $1.645$[^propuestas_metodologicas-30].
...
* $p =$ La proporción estimada (o la probabilidad del suceso). **Se recomienda** $p = 0.5$ 
...
```{r Margenesdeerrorseguntamaño, echo=FALSE, fig.cap="Márgenes de error según tamaño de la muestra" , out.width='100%' }
...
```{r Tamañodelamuestra, echo=FALSE, fig.cap="Tamaño de la muestra para distintos niveles de error estadístico" , out.width='100%' }
...
```{r Intervalodeconfianza, echo=FALSE, fig.cap="Intervalo de confianza para diferentes estimaciones" , out.width='100%' }
...
```{r Tamañodemuestra, echo=FALSE, fig.cap="Tamaño de la muestra según fórmulas de población finita e infinita" , out.width='100%'}
...
```{r Lugarderesidencia, echo=FALSE, fig.cap="Ejemplificación de un marco muestral construido en base a información recolectada en los Centros de Información Turística" , out.width='100%'}
...
```{r Coeficientes, echo=FALSE, fig.cap="Ejemplificación del cálculo de coeficientes de expansión en base a una muestra recolectada en Centros de Información Turística" , out.width='100%'}
...
```{r Casosencuestados, echo=FALSE, fig.cap="Ejemplificación del cálculo de ponderadores en base a una muestra recolectada en Centros de Información Turística" , out.width='100%'}
...
```{r Clasificaciondepersonas, echo=FALSE, fig.cap="Ejemplificación de cómo se reproduce la estructura poblacional, en base a la clasificación de las personas que ingresan a un Centro de Información Turística, en una muestra luego del uso de ponderadores para expandir los resultados de la misma" , out.width='100%' }
...
```{r Motivo, echo=FALSE, fig.cap="Ejemplificación de la distribución según motivo de viaje de los visitantes que concurrieron a un Centro de Información Turística" , out.width='100%'}
...
```{r Muestraposible, echo=FALSE, fig.cap="Ejemplificación de la selección de puntos muestrales", out.width='100%' }
...
```{r Gastototal, echo=FALSE, fig.cap="Esquema de desagregación del gasto turístico según rubro", out.width='100%' }
...
```{r Tipodetraslado, echo=FALSE, fig.cap="Descripción de los distintos tipos de traslados realizados por los visitantes desde la óptica de una provincia", out.width='100%' }
...
```{r Casos, echo=FALSE, fig.cap="Ejemplificación del cálculo del gasto diario promedio", out.width='100%' }

knitr::include_graphics('imagenes/tabla_6.png')
```

::: {.note}
**Forma de cálculo 1**:  Cada caso vale uno. Tanto la estadía como el gasto diario promedio se  estiman como un promedio simple de los valores registrados en cada caso.

Estadía promedio = (2+4+12)/3 = 6,0

Gasto diario promedio (1500+150+250)/3 = 633
...
Gasto diario promedio = ((2x1500+4x150+12x250) / (2+4+12)= 367
...
```{r Totalreal, echo=FALSE, fig.cap="Ejemplificación de las diferencias en la estimación del total de pernoctes y del gasto total según la forma de cálculo de la estadía promedio y el gasto promedio diario" , out.width='100%' }
...
```{r Formadecalculo, echo=FALSE, fig.cap="Ejemplificación de las diferencias en la estimación del total de pernoctes y del gasto total según la forma de cálculo de la estadía promedio y el gasto promedio diario en base a datos anuales del 2013 provenientes de la EVyTH" , out.width='100%' }
...
```{r grafico18a, fig.cap="Gasto diario promedio por turista según cantidad de turistas en el grupo de viaje", echo=FALSE,warning=FALSE,message=FALSE, dev='cairo_pdf', out.width='100%', out.height='100%'}
knitr::include_graphics("imagenes/DT4_grafico18_a.jpg")
```


```{r grafico18b, fig.cap="Gasto diario promedio según estadía", echo=FALSE,warning=FALSE,message=FALSE, dev='cairo_pdf', out.width='100%', out.height='100%'}
knitr::include_graphics("imagenes/DT4_grafico18_b.jpg")
```


```{r grafico18c, fig.cap="Gasto diario promedio según suma de pernoctes del grupo de viaje (turistas x estadía)", echo=FALSE,warning=FALSE,message=FALSE, dev='cairo_pdf', out.width='100%', out.height='100%'}
knitr::include_graphics("imagenes/DT4_grafico18_c.jpg")
```
