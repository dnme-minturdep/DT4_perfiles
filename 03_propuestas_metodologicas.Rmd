...
```{r echo=FALSE,warning=FALSE,message=FALSE, dev='cairo_pdf', out.width='100%', eval=FALSE}
library(tidyverse)
library(extrafont)
library(ggtext) 
...
ggsave(grafico_18a, filename = "imagenes/grafico_18a.png")

ggsave(grafico_18b, filename = "imagenes/grafico_18b.png")

ggsave(grafico_18c, filename = "imagenes/grafico_18c.png")
