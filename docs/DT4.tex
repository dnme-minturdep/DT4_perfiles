...
\textbf{Forma de cálculo 1}: Cada caso vale uno. Tanto la estadía como el gasto diario promedio se estiman como un promedio simple de los valores registrados en cada caso.
